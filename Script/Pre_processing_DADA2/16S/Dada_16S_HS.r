...
## Pre-processing of 'Hiddensea_Project'
...
filtFs <- file.path(path2, "filtrer_16S_hiddensea", paste0(sample.names, "_F_filt.fastq.bz2"))
filtRs <- file.path(path2, "filtrer_16S_hiddensea", paste0(sample.names, "_R_filt.fastq.bz2"))
