...
## Pre-processing of 'Hiddensea_Study'
...
path <- "/home/rstudio/Downloads/HS/18S"
...
filtFs <- file.path(path2, "filtrer_18S_HS", paste0(sample.names, "_F_filt.fastq.bz2"))
filtRs <- file.path(path2, "filtrer_18S_HS", paste0(sample.names, "_R_filt.fastq.bz2"))
...
saveRDS(seqtab, file = paste0(output_dir, "/Seqtab_18S_.rds"))